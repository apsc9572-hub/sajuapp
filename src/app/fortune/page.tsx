...
{
  "this_month": {
    "content": "이번 달(${tm}월) 전체 종합 운세 (가독성을 위해 5문장마다 반드시 줄바꿈(\\n\\n)을 2번 사용할 것. 반드시 포함: 핵심 키워드 3개, 전체 기운 흐름, 좋은 점, 주의할 점)",
    "score": (0-100 사이 정수),
  ...
  "week1": { "content": "1주차 흐름" },
  "week2": { "content": "2주차 흐름" },
  "week3": { "content": "3주차 흐름" },
  "week4": { "content": "4주차 흐름" },
  "week5": { "content": "5주차 흐름" },
  "wealth": { "content": "이번 달 재물운", "score": (0-100 사이 정수) },
  "love": { "content": "이번 달 애정운", "score": (0-100 사이 정수) },
  "health": { "content": "이번 달 건강운", "score": (0-100 사이 정수) },
  "career": { "content": "이번 달 사업운", "score": (0-100 사이 정수) },
  "lucky_days": "길일 목록",
  "unlucky_days": "흉일 목록",
...
{
  "this_year": {
    "content": "올해 전체 종합운 (핵심만 공백 포함 150~200자로 매우 간결하게 서술)",
    "score": (0-100 사이 정수),
  ...
  "m2": { "content": "..." },
  "m12": { "content": "..." },
  "wealth": { "content": "올해 재물운 요약", "score": (0-100 사이 정수) },
  "love": { "content": "올해 애정운 요약", "score": (0-100 사이 정수) },
  "health": { "content": "올해 건강운 요약", "score": (0-100 사이 정수) },
  "career": { "content": "올해 사업운 요약", "score": (0-100 사이 정수) },
  "lucky_months": "길월 목록",
...
반드시 아래 JSON 객체로 응답하세요:
{
  ...
  "today": { 
    "content": "오늘 종합운 핵심 풀이 (공백 포함 150~200자 이내)", 
    "score": (0-100 사이 정수),
    "scores": {"wealth":(0-100 사이 정수),"love":(0-100 사이 정수),"career":(0-100 사이 정수),"health":(0-100 사이 정수)},
    "gaewun": {"color":"색상","item":"행운의 물건","numbers":"1~99숫자5개","direction":"방향"}
  },
  "tomorrow": { "score": (0-100 사이 정수) },
  "wealth": { "content": "오늘 재물운", "score": (0-100 사이 정수) },
  "love": { "content": "오늘 애정운", "score": (0-100 사이 정수) },
  "health": { "content": "오늘 건강운", "score": (0-100 사이 정수) },
  "career": { "content": "오늘 사업운", "score": (0-100 사이 정수) }
}
