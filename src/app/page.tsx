...
import { Sparkles, MoonStar, BookOpen, Scroll, Navigation, Coins, Briefcase, Activity, Heart, Crown, ArrowRight } from "lucide-react";
      ...
      <div style={{ 
        ...
        <div className="container" style={{ width: "100%", padding: "20px 0" }}>
          ...
          >
            ...
            <div style={{ position: "relative", textAlign: "center", marginBottom: "15px", zIndex: 5 }}>
            ...
            {/* Premium Saju Banner - Moved Above for immediate visibility */}
            <motion.div 
              ...
              <Link href="/premium-saju" style={{ textDecoration: "none" }}>
                <motion.div
                  ...
                  style={{
                    ...
                    background: "linear-gradient(135deg, var(--accent-indigo), #1A1C3C)",
                    padding: "16px 20px", borderRadius: "20px", border: "1px solid rgba(201, 160, 80, 0.4)",
                    boxShadow: "0 10px 25px rgba(42, 54, 95, 0.15)", position: "relative", overflow: "hidden",
                    cursor: "pointer", minHeight: "90px"
                  }}
                >
                  <div style={{ position: "absolute", right: -20, top: -20, opacity: 0.05, transform: "rotate(-15deg)" }}>
                    <Crown size={120} color="var(--accent-gold)" />
                  </div>
                  
                  <div style={{ display: "flex", alignItems: "center", gap: "12px", zIndex: 1, minWidth: 0 }}>
                    <div style={{ 
                      width: "44px", height: "44px", borderRadius: "50%", 
                      background: "rgba(201, 160, 80, 0.15)", display: "flex", alignItems: "center", justifyContent: "center",
                      border: "1px solid rgba(201, 160, 80, 0.3)", flexShrink: 0
                    }}>
                  ...
                  <div style={{ zIndex: 1, display: "flex", alignItems: "center", justifyContent: "center", 
                    width: "36px", height: "36px", borderRadius: "50%", background: "rgba(255,255,255,0.1)", flexShrink: 0 }}>
        ...
        >
          <div style={{ textAlign: "left", color: "var(--accent-indigo)" }}>
            ...
            <div style={{ lineHeight: "2.0", fontSize: "clamp(0.88rem, 3.8vw, 1.05rem)", color: "var(--text-secondary)", wordBreak: "keep-all", overflowWrap: "break-word", fontFamily: "'Nanum Myeongjo', serif" }}>
              <section style={{ marginBottom: "clamp(32px, 6vw, 56px)" }}>
                <h3 style={{ fontSize: "clamp(1.1rem, 4.3vw, 1.35rem)", fontWeight: 700, marginBottom: "20px", color: "var(--accent-indigo)",  letterSpacing: "-0.04em", display: "flex", alignItems: "center" }}>
                  <span style={{ color: "var(--accent-gold)", marginRight: "8px" }}>01.</span>사주명리학: 삶의 지혜를 담은 동양의 정수
                </h3>
                <p>
              ...
              <section style={{ marginBottom: "clamp(32px, 6vw, 56px)" }}>
                <h3 style={{ fontSize: "clamp(1.1rem, 4.3vw, 1.35rem)", fontWeight: 700, marginBottom: "20px", color: "var(--accent-indigo)",  letterSpacing: "-0.04em", display: "flex", alignItems: "center" }}>
                  <span style={{ color: "var(--accent-gold)", marginRight: "8px" }}>02.</span>내 운명의 나침반, 사주(四柱)의 구성 원리
                </h3>
                <p>
              ...
              <section style={{ marginBottom: "clamp(32px, 6vw, 56px)" }}>
                <h3 style={{ fontSize: "clamp(1.1rem, 4.3vw, 1.35rem)", fontWeight: 700, marginBottom: "20px", color: "var(--accent-indigo)",  letterSpacing: "-0.04em", display: "flex", alignItems: "center" }}>
                  <span style={{ color: "var(--accent-gold)", marginRight: "8px" }}>03.</span>2026년 병오년(丙午年), 도약과 열정의 시기
                </h3>
                <p>
                ...
                <p style={{ marginTop: "16px" }}>
                  특히 병오년의 기운은 숨겨져 있던 진실이 드러나고, 화려하게 빛나는 시기이기도 합니다. 명예를 소중히 여기고 열정적으로 도전하는 이들에게는 병오년의 기운이 강력한 추진력이 되어줄 것입니다. 반면, 이미 화 기운이 너무 강한 사주라면 지나친 확정보다는 내실을 기하고 감정을 조절하는 지혜가 필요합니다. 청아매당은 여러분의 사주가 2026년의 뜨거운 기운과 어떻게 조화를 이룰지 정밀하게 살펴 드립니다.
                </p>
              </section>

              <section style={{ marginBottom: "clamp(32px, 6vw, 56px)" }}>
                <h3 style={{ fontSize: "clamp(1.1rem, 4.3vw, 1.35rem)", fontWeight: 700, marginBottom: "20px", color: "var(--accent-indigo)",  letterSpacing: "-0.04em", display: "flex", alignItems: "center" }}>
                  <span style={{ color: "var(--accent-gold)", marginRight: "8px" }}>04.</span>재물운을 보는 법: 풍요를 부르는 사주학적 통찰
                </h3>
                <p>
              ...
              <section style={{ marginBottom: "clamp(32px, 6vw, 56px)" }}>
                <h3 style={{ fontSize: "clamp(1.1rem, 4.3vw, 1.35rem)", fontWeight: 700, marginBottom: "20px", color: "var(--accent-indigo)",  letterSpacing: "-0.04em", display: "flex", alignItems: "center" }}>
                  <span style={{ color: "var(--accent-gold)", marginRight: "8px" }}>05.</span>개운법(開運法): 나쁜 기운을 물리치고 행운을 부르는 법
                </h3>
                <p>
              ...
              <section style={{ marginBottom: "40px" }}>
                <h3 style={{ fontSize: "clamp(1.1rem, 4.3vw, 1.35rem)", fontWeight: 700, marginBottom: "20px", color: "var(--accent-indigo)",  letterSpacing: "-0.04em", display: "flex", alignItems: "center" }}>
                  <span style={{ color: "var(--accent-gold)", marginRight: "8px" }}>06.</span>결론: 청아매당과 함께하는 새로운 운명의 시작
                </h3>
                <p>
                  사주는 우리 인생의 계절을 알려주는 지도와 같습니다. 겨울이 오면 두꺼운 옷을 준비하고, 봄이 오면 씨앗을 뿌릴 준비를 하듯, 자신의 운을 미리 알고 대비하는 것은 인생이라는 거친 바다를 항해하는 데 있어 가장 현명한 태도입니다. 청아매당의 정밀한 사주 풀이 서비스를 통해 여러분의 타고난 명식 속에 숨겨진 보석 같은 재능을 발견하고, 다가올 2026년과 그 이후의 풍요로운 미래를 전략적으로 설계해 보시기 바랍니다. 당신의 운명을 비추는 따뜻한 빛, 청아매당이 언제나 함께하겠습니다.
                </p>
