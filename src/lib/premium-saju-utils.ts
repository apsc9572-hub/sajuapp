...
export const SAJU_DICTIONARY: Record<string, string> = {
    ...
    // 2. 십성 (Ten Gods)
    "비견": "귀하 자신과 같은 기운으로, 주체성과 독립심, 강한 자아를 의미합니다.",
    "겁재": "귀하와 오행은 같으나 음양이 다른 기운으로, 경쟁심, 투지, 재물을 나누는 힘을 뜻합니다.",
    "식신": "창의성과 표현력의 기운이며, 풍요로운 의식주와 건강, 수명을 상징합니다.",
    "상관": "재치와 순발력, 뛰어난 화술을 의미하며 기존의 틀을 깨는 혁신적인 기운입니다.",
    "편재": "귀하가 통제하는 유동적인 큰 재물을 의미하며, 모험심과 기획력, 사업적 수완을 뜻합니다.",
    "정재": "정직하게 노력하여 얻는 안정적인 재물이며, 성실함과 꼼꼼한 관리력을 상징합니다.",
    "편관": "귀하를 엄격히 통제하는 기운으로, 명예와 권위, 강한 책임감과 인내심을 의미합니다.",
    ...
    "신강": "귀하의 자아 기운이 넘치고 강하여, 삶을 주도적으로 이끌어가는 힘이 큼을 의미합니다.",
